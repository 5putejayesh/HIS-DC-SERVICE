...
public interface DcService {
	...
	public boolean saveEducation(Education education); //here dto contains caseNo,highestQual,gradYear and universityName
	public boolean saveChildren(List<Child> childs);
}
